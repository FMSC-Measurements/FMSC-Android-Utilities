...
public class RecyclerViewPager extends RecyclerView {
    ...
    public int getCurrentPosition() {
        ...
        if (getLayoutManager().canScrollHorizontally()) {
            ...
            curPosition = AndroidUtils.UI.getCenterYChildPosition(this);
        }
        return curPosition;
    }
    ...
    protected void adjustPositionX(int velocityX) {
        ...
        if (childCount > 0) {
            int curPosition = AndroidUtils.UI.getCenterXChildPosition(this);
            ...
            if (targetPosition == curPosition) {
                View centerXChild = AndroidUtils.UI.getCenterXChild(this);
    ...
    protected void adjustPositionY(int velocityY) {
        int childCount = getChildCount();
        if (childCount > 0) {
            int curPosition = AndroidUtils.UI.getCenterYChildPosition(this);
            ...
            targetPosition = Math.min(targetPosition, getAdapter().getItemCount() - 1);
            if (targetPosition == curPosition) {
                View centerYChild = AndroidUtils.UI.getCenterYChild(this);
    ...
    public void onScrollStateChanged(int state) {
        ...
        if (state == SCROLL_STATE_DRAGGING) {
            mNeedAdjust = true;
            mCurView = getLayoutManager().canScrollHorizontally() ? AndroidUtils.UI.getCenterXChild(this) :
                    AndroidUtils.UI.getCenterYChild(this);
            if (mCurView != null) {
            ...
            if (mNeedAdjust) {
                int targetPosition = getLayoutManager().canScrollHorizontally() ? AndroidUtils.UI.getCenterXChildPosition(this) :
                        AndroidUtils.UI.getCenterYChildPosition(this);
                if (mCurView != null) {
