...
public class SheetLayoutEx extends FrameLayout {
    ...
    private static final int DEFAULT_START_ANIMATION_DURATION = 350;
    private static final int DEFAULT_END_ANIMATION_DURATION = 600;
    ...
    private int startAnimationDuration, endAnimationDuration;
    private int mFabSize;

    OnFabAnimationEndListener mListener;

    public SheetLayoutEx(Context context) {
        super(context);
        init();
    }

    public SheetLayoutEx(Context context, AttributeSet attrs) {
        super(context, attrs);
        init();
        loadAttributes(context, attrs);
    }

    public SheetLayoutEx(Context context, AttributeSet attrs, int defStyle) {
    ...
    private void init() {
        ...
        mFabExpandLayout = findViewById(R.id.container);
    }
    ...
    private void loadAttributes(Context context, AttributeSet attrs) {
        ...
        try {
            setColor(a.getColor(R.styleable.FooterLayout_ft_color,
                    outValue.data));
            startAnimationDuration = a.getInteger(R.styleable.FooterLayout_ft_start_anim_duration,
                    DEFAULT_START_ANIMATION_DURATION);
            endAnimationDuration = a.getInteger(R.styleable.FooterLayout_ft_end_anim_duration,
                    DEFAULT_END_ANIMATION_DURATION);
    ...
    private void expandLollipop(int x, int y, float startRadius, float endRadius) {
        ...
        toolbarExpandAnim.setDuration(startAnimationDuration);
    ...
    public static void enterFromBottomAnimation(Activity activity) {
        activity.overridePendingTransition(R.anim.activity_open_translate_from_bottom, R.anim.activity_no_animation);
    }

    public static void exitToBottomAnimation(Activity activity){
        activity.overridePendingTransition(R.anim.activity_no_animation, R.anim.activity_close_translate_to_bottom);
    }
}
