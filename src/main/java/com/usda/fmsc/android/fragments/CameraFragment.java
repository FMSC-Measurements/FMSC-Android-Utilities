...
//                }
    ...
    private void unlockFocus() {
        try {
            ...
            if (imagesCaptured < mImageReader.getMaxImages()) {
    ...
    private class ImageSaver implements Runnable {
        ...
        public void run() {
            ...
            try {
                ...
                if (listener != null) {
                    listener.onError("File save error");
                }
                error = true;
            } finally {
                mImage.close();
                if (output != null) {
                    try {
                        ...
                        if (listener != null) {
                            listener.onError("File close error");
                        }
                        error = true;
                    }
                }
